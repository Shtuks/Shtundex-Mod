...
public class DrShtuxibusEntity extends Monster implements RangedAttackMob {
	...
	public DrShtuxibusEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ShtundexModEntities.DR_SHTUXIBUS.get(), world);
	}

	public DrShtuxibusEntity(EntityType<DrShtuxibusEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.4f);
		xpReward = 32000;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RangedAttackGoal(this, 1.25, 20, 128f) {
			@Override
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		DrShtuxibusPriNachalnomPrizyvieSushchnostiProcedure.execute(world, this.getX(), this.getY(), this.getZ());
		return retval;
	}
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		ShtuxianColiderEntity.shoot(this, target);
	}
