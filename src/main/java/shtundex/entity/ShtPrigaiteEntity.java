...
public class ShtPrigaiteEntity extends Monster implements RangedAttackMob {
	public ShtPrigaiteEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ShtundexModEntities.SHT_PRIGAITE.get(), world);
	}

	public ShtPrigaiteEntity(EntityType<ShtPrigaiteEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 16000;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ShtundexModItems.SHTUXITE_BLASTER.get()));
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new LookAtPlayerGoal(this, DrShtuxibusEntity.class, (float) 10));
