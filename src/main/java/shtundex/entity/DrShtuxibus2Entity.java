...
import shtundex.procedures.DrShtuxibus2PriNachalnomPrizyvieSushchnostiProcedure;
...
public class DrShtuxibus2Entity extends Monster implements RangedAttackMob {
	...
	public DrShtuxibus2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(ShtundexModEntities.DR_SHTUXIBUS_2.get(), world);
	}

	public DrShtuxibus2Entity(EntityType<DrShtuxibus2Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.4f);
		xpReward = 32000;
		setNoAi(false);
