...
public class HumanEntity extends PathfinderMob {
	public HumanEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ShtundexModEntities.HUMAN.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(ShtundexModEntities.HUMAN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
