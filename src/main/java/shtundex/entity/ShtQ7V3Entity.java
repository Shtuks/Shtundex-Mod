...
public class ShtQ7V3Entity extends Monster {
	...
	public ShtQ7V3Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(ShtundexModEntities.SHT_Q_7_V_3.get(), world);
	}

	public ShtQ7V3Entity(EntityType<ShtQ7V3Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 16000;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ShtundexModItems.TREASURE_BAG_2.get()));
	}
