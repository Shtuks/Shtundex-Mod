...
import shtundex.procedures.ChtuxlagorMantleEffProcedure;
...
public abstract class ChtuxlagorMantleItem extends ArmorItem {
	public ChtuxlagorMantleItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(ShtundexModItems.CHTUXLAGOR_SHARD.get()));
			}

			@Override
			public String getName() {
				return "chtuxlagor_mantle";
			}
	...
	public static class Chestplate extends ChtuxlagorMantleItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "shtundex:textures/entities/catmantle.png";
		}
		...
		public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
			...
			if (entity instanceof Player player && Iterables.contains(player.getArmorSlots(), itemstack)) {
				ChtuxlagorMantleEffProcedure.execute(entity);
			}
		}
	}
}
