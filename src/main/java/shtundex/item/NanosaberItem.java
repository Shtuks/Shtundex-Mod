...
import shtundex.procedures.NanosaberPriShchielchkiePKMProcedure;
...
public class NanosaberItem extends SwordItem {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		NanosaberPriShchielchkiePKMProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);
		return ar;
	}
