...
import shtundex.procedures.DarkArmorKazhdyiTikDliaShliemaProcedure;
import shtundex.procedures.DarkArmorKazhdyiTikDliaNaghrudnikaProcedure;
...
public abstract class DarkArmorItem extends ArmorItem {
	public DarkArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(ShtundexModItems.DARK_STEEL_INGOT.get()));
			}
	...
	public static class Helmet extends DarkArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "shtundex:textures/models/armor/dark_steel__layer_1.png";
		}
		...
		public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
			...
			if (entity instanceof Player player && Iterables.contains(player.getArmorSlots(), itemstack)) {
				DarkArmorKazhdyiTikDliaShliemaProcedure.execute(entity);
			}
		}
	}
	...
	public static class Chestplate extends DarkArmorItem {
		...
		public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
			super.inventoryTick(itemstack, world, entity, slot, selected);
			if (entity instanceof Player player && Iterables.contains(player.getArmorSlots(), itemstack)) {
				DarkArmorKazhdyiTikDliaNaghrudnikaProcedure.execute(entity);
			}
		}
	}
	...
	public static class Leggings extends DarkArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "shtundex:textures/models/armor/dark_steel__layer_2.png";
		}
