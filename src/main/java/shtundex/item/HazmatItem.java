...
import shtundex.procedures.HazmatKazhdyiTikDliaNaghrudnikaProcedure;
...
public abstract class HazmatItem extends ArmorItem {
	public HazmatItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(ShtundexModItems.ANTIRAD_CLOTH.get()));
			}
	...
	public static class Helmet extends HazmatItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "shtundex:textures/models/armor/hazmat__layer_1.png";
		}
	...
	public static class Chestplate extends HazmatItem {
		...
		public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
			...
			if (entity instanceof Player player && Iterables.contains(player.getArmorSlots(), itemstack)) {
				HazmatKazhdyiTikDliaNaghrudnikaProcedure.execute(entity);
			}
		}
	}
	...
	public static class Leggings extends HazmatItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "shtundex:textures/models/armor/hazmat__layer_2.png";
		}
