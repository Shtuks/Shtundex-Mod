...
public class CatsteelWorkbenchMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CatsteelWorkbenchMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ShtundexModMenus.CATSTEEL_WORKBENCH.get(), id);
