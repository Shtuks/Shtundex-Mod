...
public class MacerguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MacerguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ShtundexModMenus.MACERGUI.get(), id);
