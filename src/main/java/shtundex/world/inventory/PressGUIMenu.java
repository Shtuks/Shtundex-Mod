...
public class PressGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PressGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ShtundexModMenus.PRESS_GUI.get(), id);
