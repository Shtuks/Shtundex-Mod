...
public class ShtundexModCustomCuriosSlots {
	...
	public static void enqueueIMC(final InterModEnqueueEvent event) {
		...
		InterModComms.sendTo("curios", SlotTypeMessage.REGISTER_TYPE, () -> new SlotTypeMessage.Builder("ram_shield").icon(new ResourceLocation("curios:slot/shielddd")).size(1).build());
	}
}
