...
public class Modelbanana<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "banana"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 11).addBox(-11.5F, -27.0F, 3.0F, 7.0F, 7.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, 24.0F, 8.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 31)
						.addBox(-11.0F, -17.0F, -7.0F, 6.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(20, 31)
						.addBox(-11.0F, -30.0F, -14.0F, 5.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.0F, 7.0F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-12.5F, -21.0F, 5.0F, 9.0F, 7.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.0F, 7.0F, 0.3927F, -0.0436F, 0.0F));

		PartDefinition cube_r3 = body.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(32, 13).addBox(-10.0F, -17.0F, -1.0F, 4.0F, 4.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone2 = body.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(36, 2)
						.addBox(-2.0F, -33.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(31, 46)
						.addBox(-3.0F, -28.0F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = bone
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(38, 31).addBox(2.5F, -21.0F, 4.0F, 2.0F, 11.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3491F));

		PartDefinition cube_r5 = bone
				.addOrReplaceChild("cube_r5",
						CubeListBuilder.create().texOffs(0, 39).addBox(-20.5F, -15.0F, 4.0F, 2.0F, 11.0F, 2.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition legL = partdefinition.addOrReplaceChild("legL",
				CubeListBuilder.create().texOffs(15, 15)
						.addBox(1.0F, 6.0F, -4.0F, 5.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(22, 24)
						.addBox(1.0F, 5.0F, -4.0F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(16, 40)
						.addBox(2.0F, -7.0F, -2.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.0F, 16.0F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition legR2 = partdefinition.addOrReplaceChild("legR2",
				CubeListBuilder.create().texOffs(19, 4)
						.addBox(-6.0F, -2.0F, -4.0F, 5.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 24)
						.addBox(-6.0F, -3.0F, -4.0F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(8, 39)
						.addBox(-4.0F, -15.0F, -2.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)),
